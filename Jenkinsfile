 node {
    ...
    def application_name= "geetask_lapig"
		...
		def scannerHome = tool 'sonarqube-scanner';
                    ...
                    -Dsonar.projectKey=GEEController-server \
                    -Dsonar.sources=. \
                    -Dsonar.css.node=. \
        ...
        stage('Deploy container on DEV') {
                        ...
                        configFileProvider([configFile(fileId: "$File_Json_Id_GEE_TASK_HOMOL", targetLocation: 'container-atlas-deploy-homol.json')]) {
